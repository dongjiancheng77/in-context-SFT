...
def greedy_tsp(embeddings,instruction_list):
    ...
    for x in range(1, n):
        ...
        prompt='You are an AI assistant designed to determine whether the following two math problems can provide contextual information to help LLM learning. You should give an overall score on a scale of 1 to 10, where a higher score indicates higher degree of correlation. /n '
        input_text=prompt+instruction_list[next_index]+' /n '+instruction_list[last]
...
def main(input_file, output_file):
    ...
    res = greedy_tsp(text_embedding,instruction_list)
